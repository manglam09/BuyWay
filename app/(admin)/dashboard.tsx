    ...
    const renderCategoryCard = (cat: string) => {
        ...
        return (
            <TouchableOpacity key={cat} style={[styles.categoryAdminCard, { width: COLUMN_WIDTH }]} activeOpacity={0.9} onPress={() => setSelectedCategory(isActive ? null : cat)}>
                <Image source={{ uri: CATEGORY_IMAGES[cat] || 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&q=80' }} style={styles.categoryAdminImage} />
                ...
                <View style={[styles.hero, { paddingTop: insets.top + 20 }]}>
                    <View style={styles.topRow}>
                        ...
                        <View style={styles.headerRight}>
                            ...
                            <TouchableOpacity onPress={handleLogout}><Image source={{ uri: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=200' }} style={styles.adminAvatar} /></TouchableOpacity>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    scrollView: { flex: 1 },
    hero: { paddingHorizontal: 25, paddingBottom: 20 },
    topRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    backFab: { width: 45, height: 45, borderRadius: 15, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', elevation: 5 },
    ...
    tabBar: { flexDirection: 'row', backgroundColor: 'rgba(148, 163, 184, 0.1)', marginHorizontal: 25, borderRadius: 20, padding: 6, marginTop: 20 },
    ...
    statCard: { width: (width - 65) / 2, height: 160, borderRadius: 30, overflow: 'hidden', elevation: 8 },
    ...
    insightCard: { backgroundColor: '#FFF', borderRadius: 24, padding: 18, flexDirection: 'row', alignItems: 'center', elevation: 2 },
    ...
    actionsScroll: { marginHorizontal: -25, paddingHorizontal: 25, marginBottom: 10 },
    actionCard: { width: 140, height: 110, borderRadius: 28, overflow: 'hidden', marginRight: 15, elevation: 5 },
    ...
    feedCard: { backgroundColor: '#FFF', borderRadius: 30, padding: 20, elevation: 2 },
    ...
    trafficModule: { width: 120, backgroundColor: '#FFF', borderRadius: 30, padding: 20, elevation: 2, alignItems: 'center', justifyContent: 'center', position: 'relative' },
    ...
    healthCard: { backgroundColor: '#FFF', borderRadius: 20, padding: 18, elevation: 2 },
    ...
    categoryAdminCard: { height: 180, borderRadius: 30, overflow: 'hidden', elevation: 8 },
    ...
    searchBox: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderRadius: 20, paddingHorizontal: 15, height: 55, elevation: 3 },
    searchInput: { flex: 1, marginLeft: 10, fontSize: 14, color: '#1e293b', fontWeight: '600' },
    fabAdd: { width: 55, height: 55, borderRadius: 20, overflow: 'hidden', elevation: 5 },
    fabGradient: { flex: 1, justifyContent: 'center', alignItems: 'center' },
    productGrid: { gap: 15 },
    productCard: { backgroundColor: '#FFF', borderRadius: 24, padding: 12, elevation: 2 },
    ...
    orderGrid: { gap: 15 },
    orderCard: { backgroundColor: '#FFF', borderRadius: 24, padding: 16, elevation: 2 },
